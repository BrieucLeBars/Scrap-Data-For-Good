...
from keywords_processing import get_study, to_text, get_tags, get_salary
...
def start(scrap_keywords, scrap_locations_w_radius, description_keywords, result_nb):
...
if __name__ == "__main__":
    ...
    storage_dict = start(scrap_keywords, scrap_locations_w_radius, description_keywords, result_nb)
    json.dump(storage_dict, open("test", "wb"))
                #faire un script qui permet de sortir seulement les coordonnees
